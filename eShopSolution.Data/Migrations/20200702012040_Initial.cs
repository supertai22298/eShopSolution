        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 7, 2, 8, 20, 40, 23, DateTimeKind.Local).AddTicks(377)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 7, 2, 8, 20, 40, 37, DateTimeKind.Local).AddTicks(8304), 100000m, 200000m, null });
